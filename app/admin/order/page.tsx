...
// Pastikan path import ini sesuai dengan lokasi file kamu sebenarnya
    ...
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      ...
      <Card className="p-4 border-none shadow-sm flex flex-col md:flex-row gap-4 items-center justify-between bg-white dark:bg-slate-900">
        ...
        <div className="flex items-center gap-2 overflow-x-auto w-full md:w-auto">
          <ListFilter className="w-4 h-4 text-slate-400 mr-2" />
        ...
        <Table>
          ...
          <TableBody>
            {filteredOrders.length > 0 ? (
              ...
              <TableRow>
                {/* Sekarang TableCell sudah terdefinisi karena sudah di-import */}
